...
function Navbar({page=""}) {
    ...
    <>
        ...
        <div className={` h-full max-w-screen-xl flex flex-wrap items-center justify-between m-auto z-90 md:pl-5`}>
            ...
            <div className="flex items-center" id="navbar-sticky">
                <ul className="flex items-center flex-col p-4 md:p-0 font-medium border border-gray-100 rounded-lg  md:space-x-8 md:flex-row md:mt-0 md:border-0 dark:border-gray-700">
                    <li>
                        <Link to="/" className="block  px-3  rounded-sm md:bg-transparent md:text-white md:p-0 md:dark:text-white">Home</Link>
                    </li>
                    <li>
                        <Link to="/about" className="block py-2 px-3  rounded-sm md:bg-transparent md:text-white md:p-0 md:dark:text-white">About</Link>
                    </li>
                    <li>
                        <Link to="/events" className="block py-2 px-3 text-white md:text-white md:p-0 md:dark:text-white">Events</Link>
                    </li>
                    <li>
                        <Link to="/donate" className="block py-2 px-3 rounded-sm md:bg-transparent md:text-white md:p-0 md:dark:text-white">Donate</Link>
                    </li>
                    <li>
                        <Link to="/contact" className="block py-2 px-3  rounded-sm md:bg-transparent md:text-white md:p-0 md:dark:text-white">Contact</Link>
                    </li>
                </ul>
            </div>
        </div>
