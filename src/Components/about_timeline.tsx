  ...
  return (
    <>
      ...
      >
        ...
        <li>
          <hr />
          <div className="timeline-start text-black">2023</div>
          <div className="timeline-middle">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className="h-5 w-5">
              <path
                fillRule="evenodd"
          ...
          <div className="timeline-end timeline-box text-center">
            Purchased 6-acre property to build the sanctuary
          </div>
          <hr />
        </li>
        ...
        <li>
          ...
          <div className="timeline-end timeline-box text-center">
            Selected general contractor and applied for permits
          </div>
          <hr />
        </li>
      </ul>
