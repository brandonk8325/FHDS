export function EmailForm({name = "email"}){
    return (
        ...
        <fieldset className="fieldset" >
            ...
            <input type="email" autoComplete="email" name = {name} className="bg-[#f6eee3] border-l-1 border-neutral-400 focus:ring-0 text-black" placeholder="mail@site.com" required />
            </label>
