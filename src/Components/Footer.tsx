        ...
        <>
            <div className={`flex flex-col py-10 bg-darkgreen w-full`} >
                    ...
                    <div className="flex justify-center gap-5 flex-col md:flex-row items-center lg:gap-60 md:gap-20">
                        ...
                        <div className="lg:w-150 md:w-full flex justify-start text-center md:text-left">
                            ...
                            >
                                ...
                                <label htmlFor="input-group-1" className="border-0 shadow-0  text-sm font-medium  text-white bg-*  ">Join our Newsletter</label>
                                <div className="flex flex-col md:flex-row bg-*">
                                    <div className="join border-0 shadow-0 h-10">
                                        <div>
                                            ...
                                            <input name="email" type="email" autoComplete="email" className="placeholder-white/70 focus:outline-none focus:ring-0 focus:border-transparent" placeholder="mail@site.com" required />
                                            </label>
                ...
                <div className="flex flex-col items-center justify-center pt-5">
                    <hr className="h-px  w-full md:w-150 block bg-gray-100 border-0 "></hr>
